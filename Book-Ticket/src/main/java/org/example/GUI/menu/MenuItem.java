...
public class MenuItem extends JPanel {
    ...
    private Icon getIcon() {
        ...
        Color iconColor = FlatLaf.isLafDark()
                ? FlatUIUtils.getUIColor("Menu.icon.darkColor", new Color(200, 200, 200))
                : Color.WHITE;
        // Map the default SVG gray to current theme icon color
        colorFilter.add(Color.decode("#969696"), iconColor, iconColor);
    ...
    private void init() {
        ...
        String bgStyle = FlatLaf.isLafDark() ? "background:$Menu.background;" : "background:null;";
    ...
    private JButton createButtonItem(String text) {
        ...
        // Force transparency in light mode so buttons don't become "white cards"
        ...
        button.putClientProperty(FlatClientProperties.STYLE, ""
                ...
                + "hoverBackground:mix($Menu.button.selectedBackground,rgba(255,255,255,0),50%);"
                + "borderWidth:0;"
                + "focusWidth:0;"
                + "innerFocusWidth:0;"
                + "arc:10;"
                ...
                + "margin:3,11,3,11");
        if (!dark) {
            // In light mode, force text color to pure white so it stands out on gradient background
